    ...
    public class LoginController : ControllerBase
    {
        ...
        public IActionResult Authenticate(LoginUser userParam)
        {
            ...
            if (user != null && passwordHasher.VerifyHashMatch(user.PasswordHash, userParam.Password, user.Salt))
            {
                ...
                LoginResponse retUser = new LoginResponse() { User = new ReturnUser() { UserId = user.UserId, Username = user.Username, Role = user.Role, ProfilePicture = user.ProfilePicture }, Token = token };
        ...
        public IActionResult Register(RegisterUser userParam)
        {
            ...
            User user = userDAO.AddUser(userParam.Username, userParam.Password, userParam.Role, userParam.ProfilePicture);
            if (user != null)
            {
